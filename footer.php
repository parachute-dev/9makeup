...
<div class="newsletter-block content-block">
	<div class="container">
		<div class="row is-flex">
			...
			<div class="col-md-8">
				...
				<form method="POST" action="https://9makeup36839.activehosted.com/proc.php" id="_form_1_" class="_form _form_1 _inline-form  _dark" novalidate>
					...
					<div class="_form-content">
						...
						<input ype="text" name="email" placeholder="Email Address" required >
...
(function() {
	...
	var form_submit = function(e) {
      ...
      _load_script('https://9makeup36839.activehosted.com/proc.php?' + serialized + '&jsonp=true');
  }
  return false;
};
