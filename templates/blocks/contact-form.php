            ...
            <div class="row is-flex">
                <div class="col-md-4 ">
                    <div class="testimonial-item">
                        ...
                        <header class="content-header content-header-underline">
                            <h5>Email</h5>
                            <h6>  <a style="color:inherit" href="tel:<?php the_field('email_address','option') ?>">
                ...
                <div class="col-md-4 ">
                    <div class="testimonial-item">
                        ...
                        <header class="content-header content-header-underline">
                            <h5>Phone</h5>
                            <h6> 
                               <a style="color:inherit" href="tel:<?php the_field('telephone_number','option') ?>"> <?php the_field('telephone_number','option') ?></a>
                            </h6>
                        </header>
                    </div>
                </div>
