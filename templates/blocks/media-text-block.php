...
<?php foreach($_items as $_item): ?>
    ...
    $banner_style = $_item->getData('banner_style');
    ...
    $content_size = !empty($_element->getData('content_size')) ? $_element->getData('content_size') : "medium";
  $content_width = !empty($_item->getData('content_width')) ? $_item->getData('content_width') : "half";
    ...
    $class_arr[] = "justify-content-" . $content_justify;
        $class_arr[] = "content-size-" . $content_size;
    ...
    <div class="media-text-block content-block content-width-<?php echo $content_width?> container-height-<?php echo $content_size; ?> style-<?php echo $banner_style?> text-<?php echo $text_align; ?> vertical-<?php echo $content_align;?> horizontal-<?php echo $content_justify;?>">
        <div class="container">
